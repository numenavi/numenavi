...
export const LessonButton = ({
    ...
    const href = isCompleted ? "/learn" : "/lesson";
            ...
            >
                {current ? (
                    <div className="h-25.5 w-25.5 relative">
                        <div className="absolute -top-6 left-2.5 px-3 py-2.5 border-2 font-bold uppercase text-[#9B6DFF] bg-white rounded-xl animate-bounce tracking-wide z-10">
                            Start
                            <div 
